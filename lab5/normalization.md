...
UserID → Position. (Вважається, що це єдиний ФЗ, але ми знаємо, що він помилковий з точки зору бізнес-логіки)Проблема (Порушення 3NF): Роль (Position) є контекстуальною (наприклад, у команді), тому вона не повинна зберігатися в таблиці "User". 

Вона повинна залежати від складеного ключа в проміжній таблиці, щоб коректно відображати: "Користувач X має Роль Y у Команді Z".
